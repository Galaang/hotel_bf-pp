      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="rooms.html" class="nav-link">Apartment Room</a>
            </li>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text p-4 text-center">
                <h3 class="heading">
                  <a href="#"
                    >Work Hard, Party Hard in a Luxury Chalet in the Alps</a
                  >
                </h3>
                <div class="meta mb-2">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
            ...
            <a href="#"
              >Read more
              <span class="fa fa-chevron-right" style="font-size: 11px"></span
            ></a>
          </div>
          <div class="col-md-6 col-lg-3 mb-md-0 mb-4">

        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Tambah Kamar</h5>
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="/registerRoom/store" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Nama Kamar</label>
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="kamar" placeholder="kamar">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="jumlah_kasur" placeholder="Jumlah kasur">
                                        </div>
